	              ...
	              error: function(xhr) {
	            	  ...
	            	  setTimeout(function(){
			            ...
			            if(xhr.responseText == 'files not aligned on paragraph level'){
			            	$('[data-toggle="popover"]').popover({container: 'body', trigger: 'manual', delay: {show: 0, hide: 0}, html: true, content: (xhr.responseText+"<br />please save the source to doc format and try again.<br /><br />"+"<a class=\"pafilelink\">Paragraph Alignment File</a>")});
			            }else{
