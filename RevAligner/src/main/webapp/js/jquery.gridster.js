...
;(function($, window, document, undefined) {
    ...
    */
	...
	fn.swap_widgets = function($widget1, $widget2) {
        var widget_grid_data1 = $widget1.coords().grid;
        var row1 = widget_grid_data1.row;
        
        var widget_grid_data2 = $widget2.coords().grid;
        var row2 = widget_grid_data2.row;

        this.remove_from_gridmap(widget_grid_data1);
        this.remove_from_gridmap(widget_grid_data2);
        
        widget_grid_data1.row = row2;
        widget_grid_data2.row = row1;
        
        this.add_to_gridmap(widget_grid_data1);
        this.add_to_gridmap(widget_grid_data2);
        
        $widget1.attr('data-row', row2);
        this.$changed = this.$changed.add($widget1);

        $widget2.attr('data-row', row1);
        this.$changed = this.$changed.add($widget2);
    ...
    */
    fn.move_widget_up = function($widget, y_units) {
    	var wgd = {
            ...
            'size_x': parseInt($widget.attr('data-sizex'), 10),
            'size_y': parseInt($widget.attr('data-sizey'), 10),
            'el': $widget
        };
        $widget.data('coords', $widget.coords());
        $widget.data('coords').grid = wgd;
